---
layout: post
title: Caprice is here
---

Now, I'm proud to announce the very first preview of Caprice Linux is released. It took days and hours of hardwork and research, and it made _Caprice_ a good place to experience different things for other project I'm working on. 

## Features of version 20200416 

- Minimal Debian Stable Environment (no X)
- Some customization done on the base system 
...
ii  libnm0:amd64                  1.14.6-2+deb10u1                    amd64        GObject-based client library for NetworkManager
...
ii  libqt5core5a:amd64            5.11.3+dfsg1-1+deb10u2              amd64        Qt 5 core module
ii  libqt5dbus5:amd64             5.11.3+dfsg1-1+deb10u2              amd64        Qt 5 D-Bus module
ii  libqt5gui5:amd64              5.11.3+dfsg1-1+deb10u2              amd64        Qt 5 GUI module
ii  libqt5network5:amd64          5.11.3+dfsg1-1+deb10u2              amd64        Qt 5 network module
ii  libqt5svg5:amd64              5.11.3-2                            amd64        Qt 5 SVG module
ii  libqt5widgets5:amd64          5.11.3+dfsg1-1+deb10u2              amd64        Qt 5 widgets module
...
ii  live-boot                     1:20190614                          all          Live System Boot Components
ii  live-boot-doc                 1:20190614                          all          Live System Boot Components (documentation)
ii  live-boot-initramfs-tools     1:20190614                          all          Live System Boot Components (initramfs-tools backend)
ii  live-tools                    1:20171207                          all          Live System Extra Components
...
ii  ppp                           2.4.7-2+4.1                         amd64        Point-to-Point Protocol (PPP) - daemon
...
ii  qt5-gtk-platformtheme:amd64   5.11.3+dfsg1-1+deb10u2              amd64        Qt 5 GTK+ 3 platform theme
...
ii  wpagui                        2:2.7+git20190128+0c1e29f-6+deb10u1 amd64        graphical user interface for wpa_supplicant
